...
--> statement-breakpoint
INSERT INTO `__new_divisions`("id", "slug", "name", "shortName", "alternativeNames", "weightLimitPounds", "weightLimitKilograms", "weightLimitStone", "createdAt", "updatedAt") SELECT "id", "slug", "name", "shortName", "alternativeNames", "weightLimitPounds", "weightLimitKilograms", "weightLimitStone", "createdAt", "updatedAt" FROM `divisions`;--> statement-breakpoint
