...
-- Using INSERT OR IGNORE to make this migration idempotent
INSERT OR IGNORE INTO divisions (id, slug, name, shortName, weightLimitPounds, weightLimitKilograms, weightLimitStone, alternativeNames) VALUES
