...
export default defineTask({
  ...
  async run() {
    ...
    const divisionsData = [
      ...
      { id: 'flyweight', slug: 'flyweight', name: 'Flyweight', shortName: 'fly', weightLimitPounds: 112, weightLimitKilograms: 50.802, weightLimitStone: '8st', alternativeNames: null },
      ...
      { id: 'bantamweight', slug: 'bantamweight', name: 'Bantamweight', shortName: 'bantam', weightLimitPounds: 118, weightLimitKilograms: 53.525, weightLimitStone: '8st 6lbs', alternativeNames: null },
      ...
      { id: 'featherweight', slug: 'featherweight', name: 'Featherweight', shortName: 'feather', weightLimitPounds: 126, weightLimitKilograms: 57.153, weightLimitStone: '9st', alternativeNames: null },
      ...
      { id: 'lightweight', slug: 'lightweight', name: 'Lightweight', shortName: 'light', weightLimitPounds: 135, weightLimitKilograms: 61.235, weightLimitStone: '9st 9lbs', alternativeNames: null },
      ...
      { id: 'welterweight', slug: 'welterweight', name: 'Welterweight', shortName: 'welter', weightLimitPounds: 147, weightLimitKilograms: 66.678, weightLimitStone: '10st 7lbs', alternativeNames: null },
      ...
      { id: 'middleweight', slug: 'middleweight', name: 'Middleweight', shortName: 'middle', weightLimitPounds: 160, weightLimitKilograms: 72.574, weightLimitStone: '11st 6lbs', alternativeNames: null },
      { id: 'super-middleweight', slug: 'super-middleweight', name: 'Super Middleweight', shortName: 'super middle', weightLimitPounds: 168, weightLimitKilograms: 76.203, weightLimitStone: '12st', alternativeNames: null },
      { id: 'light-heavyweight', slug: 'light-heavyweight', name: 'Light Heavyweight', shortName: 'light heavy', weightLimitPounds: 175, weightLimitKilograms: 79.378, weightLimitStone: '12st 7lbs', alternativeNames: null },
      ...
      { id: 'heavyweight', slug: 'heavyweight', name: 'Heavyweight', shortName: 'heavy', weightLimitPounds: 201, weightLimitKilograms: 90.719, weightLimitStone: `14st 5lbs`, alternativeNames: null },
    ]
