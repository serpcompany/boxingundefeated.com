<script setup lang="ts">
  useSeoMeta({
    title: 'DMCA Policy - Boxing Undefeated',
    description:
      'Digital Millennium Copyright Act (DMCA) policy for Boxing Undefeated.',
  })
</script>

<template>
  <div class="max-w-4xl mx-auto px-6 lg:px-8 py-12">
    <h1 class="text-3xl font-bold text-highlighted">DMCA Policy</h1>

    <div class="mt-8 prose prose-neutral max-w-none dark:prose-invert">
      <p>Last updated: {{ new Date().toLocaleDateString() }}</p>

      <p>
        Boxing Undefeated respects the intellectual property rights of others
      ...
      <p>
        ...
        constitutes copyright infringement and is accessible on this site, you
        may notify our copyright agent, as set forth in the DMCA. For your
      ...
      <p>
        In accordance with the DMCA and other applicable law, Boxing Undefeated
        has adopted a policy of terminating, in appropriate circumstances and at
        Boxing Undefeated's sole discretion, users who are deemed to be repeat
        infringers.
      </p>

      <h2>Intellectual Property Protection</h2>
      <p>We take intellectual property very seriously.</p>

      <h2>Contact Information</h2>
      <p>
        If you would like to file a complaint regarding the DMCA or other
        intellectual property matters, please email: dmca[@]boxingundefeated.com
        and/or ipcomplaints[@]boxingundefeated.com Please make sure you remove
        the brackets [ ] and spaces in the above provided emails. We format it
        like this to reduce spam from bots, spiders, and scrapers. Thank you.
      </p>
    </div>
  </div>
</template>
