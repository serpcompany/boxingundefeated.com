<script setup lang="ts">
  useSeoMeta({
    title: 'Privacy Policy - Boxing Undefeated',
    description:
      'Privacy policy and data protection information for Boxing Undefeated.',
  })
</script>

<template>
  <div class="max-w-4xl mx-auto px-6 lg:px-8 py-12">
    <h1 class="text-3xl font-bold text-highlighted">Privacy Policy</h1>

    <div class="mt-8 prose prose-neutral max-w-none dark:prose-invert">
      <p>Last updated: {{ new Date().toLocaleDateString() }}</p>

      <p>
        Boxing Undefeated ("we," "our," or "us") is committed to protecting your
